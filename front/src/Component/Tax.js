        ...
        <Box sx={{ display: 'flex' }}>
          ...
          <Box sx={{ flex: 1, bgcolor: '#f9fafc', minHeight: '100vh' }}>
            ...
            <Box sx={{
              ...
              <Typography variant="h6" sx={{ fontWeight: 600 }}>Tax</Typography>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <Paper elevation={0} sx={{
                  display: 'flex', alignItems: 'center',
                  px: 1.5, py: 0.5, borderRadius: '999px',
                  border: '1px solid #e0e0e0', bgcolor: '#f9fafb',
                  width: 240,
                }}>
            ...
            <Box sx={{
              ...
              <Typography variant="body2" color="text.secondary">
                Add and manage your Tax, all in one place.
              </Typography>
              <Button
                variant="contained"
                sx={{
