...
import { TextField, InputAdornment, IconButton,Paper, InputBase } from '@mui/material';
        ...
        <Box display="flex">
            ...
            <Box flex={1}>
                  <Box sx={{
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 600 }}>Purchase & Order</Typography>
              ...
              <UserMenu />
                ...
                >
                    ...
                    <Typography fontSize={13} color="text.secondary" sx={{ maxWidth: 300, mb: 2 }}>
                        Add and manage your Purchase Order, all in one place.
                    </Typography>
                    ...
                    }} startIcon={<AddIcon />}  onClick={() => navigate('/add-purchase-order')}>
